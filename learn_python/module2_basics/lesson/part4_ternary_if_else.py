...
Ternary, meaning composed of three parts are shorthand if/else switches that
are expressions not statements. This means they always produce a value.

Format: <expression> if <condition> else <expression>
"""
